...
public class Doll {
	...
	LoadedObjectVertexNormal[] bodyForDraws;
	
	float mass = 1; //刚体质量
	float bodyCenterH = 7; //人偶中心高度
	...
	public Doll(View view, DynamicsWorld dynamicsWorld, LoadedObjectVertexNormal[] bodyForDraws){
	...
	public void initShapes(){
		...
		bodyShapes[BodyPartIndex.BODYPART_LEFT_UPPER_LEG.ordinal()] = new CapsuleShape(leftUpperLegR, leftLowerLegH);
	...
	public void initRigidBodys(){
		...
		//脊椎
		tempTrans.setIdentity();
		tempTrans.origin.set(0, bodyCenterH + spineTH/2, 0);
		...
		//右大臂
		tempTrans.setIdentity();
		tempTrans.origin.set(spineR + rightUpperArmTH/2, bodyCenterH + spineTH - spineR, 0);
		...
		//右小臂
		tempTrans.setIdentity();
		tempTrans.origin.set(spineR + rightUpperArmTH + rightLowerArmTH/2, bodyCenterH + spineTH - spineR, 0);
		...
		//左大臂
		tempTrans.setIdentity();
		tempTrans.origin.set(-spineR - leftUpperArmTH/2, bodyCenterH + spineTH - spineR, 0);
		...
		//左小臂
		tempTrans.setIdentity();
		tempTrans.origin.set(-spineR - leftUpperArmTH - leftLowerArmTH/2, bodyCenterH + spineTH - spineR, 0);
		...
		//骨盆
		tempTrans.setIdentity();
		tempTrans.origin.set(0, bodyCenterH - pelvisTH/2, 0);
		...
		//右大腿
		tempTrans.setIdentity();
		tempTrans.origin.set(pelvisR + rightUpperLegR, bodyCenterH - pelvisTH + pelvisR - rightUpperLegTH/2, 0);
		...
		localA.setIdentity();
		localB.setIdentity();
		localA.origin.set(0f, -headTH, 0);
		localB.origin.set(0f, pelvisTH, 0);
		joint6DOF = new Generic6DofConstraint(rigidBodies[BodyPartIndex.BODYPART_HEAD.ordinal()], rigidBodies[BodyPartIndex.BODYPART_PELVIS.ordinal()], localA, localB, true);
		...
		localA.setIdentity();
		localB.setIdentity();
		localA.origin.set(spineR, spineTH/2 - rightUpperArmR*2, 0);
